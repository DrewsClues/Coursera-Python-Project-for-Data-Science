...
app.layout = html.Div([
    #TASK 2.1 Add title to the dashboard
     html.H1("Automobile Sales Statistics Dashboard", 
            style={"textAlign": "center", "color": "#503D36", "fontSize": "24px"}),  
    ...
    html.Div([
        html.Label("Select Statistics:"),
          dcc.Dropdown(id='dropdown-statistics', 
                  ...
                  style={"text-align-last: center; width: 80%; font-size: 20px; padding: 3px;"})
    ]),
...
# Plot bar 3 chart for average number of vehicles sold during the given year
        # grouping data for plotting.
        # Hint:Use the columns Year and Automobile_Sales
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                ...
                html.Div(className='chart-item', cchildren=[html.Div(children=Y_chart3), html.Div(children=Y_chart4)],style={'display': 'flex'})
